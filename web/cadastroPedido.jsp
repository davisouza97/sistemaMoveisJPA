            ...
            <div">
                ...
                <table id="tabelaProdutos" class="table">
                    ...
                    <c:forEach items="${moveisDoPedido}" var="movelPedido">
                        <tr>
                            <td><input type='text' class="form-control" id="nome<%out.print(j);%>" value="${movelPedido.movel.nome}" readonly></td>
                            <td><input type='text' class="form-control" id="preco<%out.print(j);%>" value="${movelPedido.movel.preco}" readonly></td>
                            <td><input type="number" class="form-control" id="qtd<%out.print(j);%>" name="qtd<%out.print(j);%>" value="${movelPedido.quantidade}" min="1" oninput="mudarValor(this)" ></td>
                            <td><input  type="number" class="form-control" id="vt<%out.print(j);%>" name="vt<%out.print(j);%>" value="${movelPedido.quantidade*movelPedido.movel.preco}" readonly></td>
                            <td><button class="btn btn-danger" type="button" onclick='removeLinha(this)'>Remover</button></td>
                            <td><input type='number' class="form-control" id="id<%out.print(j);%>" name="id<%out.print(j++);%>" value="${movelPedido.movel.id}" hidden></td>
                        </tr>
                    </c:forEach>
                </table>
                </div>
