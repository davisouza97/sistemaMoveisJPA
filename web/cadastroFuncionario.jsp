                ...
                <table class="tableform">
                    ...
                    <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="1">
                                    <input class="form-control" type="text" required name="cep" id="cep" value="${funcionario.cep}" oninput="pesquisacep(this.value)" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>>
                            </td>
                        </tr>
                        <tr>
                            <td>
