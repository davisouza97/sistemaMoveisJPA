                ...
                <table class="tableform">
                    ...
                    <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="1">
                                <input class="form-control" type="text" required min="1" name="cep" id="cep" value="${fornecedor.cep}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td colspan="4">
                                <input class="form-control" type="text" required maxlength="45" minlength="3" name="logradouro" id="rua" value="${fornecedor.logradouro}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input class="form-control" type="text" required maxlength="45" minlength="3" name="bairro" id="bairro" value="${fornecedor.bairro}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>>
                            </td>
                        </tr>
                        <tr>
                            <td>
